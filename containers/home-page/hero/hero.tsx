...
export function Hero() {
  return (
    <div className="h-screen w-full flex flex-col justify-between items-center sm:pt-[12%] pt-40 ">
      ...
      <a className="fadeDown animate-fadeDownDelayed" href="#about-me">
        <DownArrowIcon className="text-accent-overlay hover:text-light-secondary  h-10 mb-8" />
      </a>
    </div>
  );
}
